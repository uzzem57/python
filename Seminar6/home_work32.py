...
print(my_list_index)
# Можно так же написать проверку на предмет вхождения диапазона в изначальный массив, а так
# же , что бы цифра начала диапазона не была больше цифры конца диапазона